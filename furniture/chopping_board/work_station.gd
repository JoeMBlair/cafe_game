...
func _process(delta):
	if is_open:
		$CanvasLayer/Bowl/Select.global_position = inventory["Mixing Bowl"][space_select]["Spot"].global_position
		get_input()
